...
func boss_signal(sig :String, value1, value2):
	match sig:
		"spawn_enemies":
			...
			if is_multiplayer:
				Spawner.spawn_enemies([player1,player2], self, get_cells_in_radius(value1,value2).duplicate(),LayerManager.room_instance_data,LayerManager,true,value1,value2)
			else:
				Spawner.spawn_enemies([player1], self, get_cells_in_radius(value1,value2).duplicate(),LayerManager.room_instance_data,LayerManager,true,value1,value2)
